// not currently supporting virtual table definition from within JS
// rming test for it.
// vtab definition from js will work if we track down
// where bigints are passed to the vtab vs normal ints
